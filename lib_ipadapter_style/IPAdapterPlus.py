...
class To_KV(nn.Module):
    def __init__(self, state_dict):
        ...
        for key, value in state_dict.items():
            ...
            self.to_kvs[key.replace(".weight", "").replace(".", "_")].weight.data = value.clone().detach()
...
class IPAdapterApply:
    ...
    def apply_ipadapter(self, ipadapter, model, weight, clip_vision=None, image=None, weight_type="original",
        ...
        output_cross_attention_dim = 2048 or ipadapter["ip_adapter"]["1.to_k_ip.weight"].shape[1]
